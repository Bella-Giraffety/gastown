...
// ListIssueStatuses returns durable issues matching any of the supplied statuses
// with one bd query when using the CLI backend. It is intended for bulk summary
// paths where separate status-wide scans would multiply bd subprocesses.
