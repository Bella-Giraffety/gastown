...
func DefaultBdCli() *BdCli {
	return &BdCli{
		Exec: func(workDir string, args ...string) (string, error) {
			out, err := beads.NewWithBeadsDir(workDir, beads.ResolveBeadsDir(workDir)).Run(args...)
			return strings.TrimSpace(string(out)), err
		},
		Run: func(workDir string, args ...string) error {
			_, err := beads.NewWithBeadsDir(workDir, beads.ResolveBeadsDir(workDir)).Run(args...)
			return err
		},
	}
}
