...
// detectTownRootFromCwd resolves canonical town authority for control-plane
// commands. It prefers explicit town-root env vars, then falls back to cwd
// discovery, then finally checks tmux global env for run-shell cases.
