...
// WorktreeIntegrityError identifies structural worktree damage that cannot be
// fixed by normal git cleanup inside the worktree.
...
// IsStructuralWorktreeError reports whether err proves the worktree structure is
// broken, as opposed to a transient git command, permission, or tooling failure.
...
// VerifyWorktreeExists checks that a git worktree exists at clonePath and that
// its .git indirection points at a real gitdir.
