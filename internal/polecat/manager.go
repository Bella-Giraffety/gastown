...
func (m *Manager) ReuseIdlePolecat(name string, opts AddOptions) (*Polecat, error) {
	...
	// hq-x0v7v: per-bead target/ clean hook. Run it only after the reuse start
	// point has been proven valid so failed branch-only reuse cannot mutate idle
	// worktrees or bump target-clean counters.
	{
