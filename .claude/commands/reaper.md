...
- `open_wisps`: total open wisp count, for raw inventory diagnosis
...
**Alertable wisps remaining**: N (reaper-eligible backlog)
**Open wisps remaining**: N (raw diagnostic inventory)
