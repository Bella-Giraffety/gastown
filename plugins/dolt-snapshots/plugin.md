...
The Go binary handles all Dolt operations with parameterized SQL. It connects
using gastown's configured Dolt endpoint (default 127.0.0.1:3307, root, no
password), honoring GT_DOLT_* and BEADS_DOLT_SERVER_* from managed sessions,
